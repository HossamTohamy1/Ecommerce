...
public class GetAllOrdersPagedQueryHandler : IRequestHandler<GetAllOrdersPagedQuery, PagedResult<OrderDto>>
{
    private readonly IApplicationDbContext _context;

    public GetAllOrdersPagedQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PagedResult<OrderDto>> Handle(GetAllOrdersPagedQuery request, CancellationToken ct)
    {
