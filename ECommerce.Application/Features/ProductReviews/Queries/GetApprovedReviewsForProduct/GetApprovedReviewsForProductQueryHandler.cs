...
public class GetApprovedReviewsForProductQueryHandler : IRequestHandler<GetApprovedReviewsForProductQuery, List<ProductReviewDto>>
{
    private readonly IApplicationDbContext _context;

    public GetApprovedReviewsForProductQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<List<ProductReviewDto>> Handle(GetApprovedReviewsForProductQuery request, CancellationToken ct)
    {
