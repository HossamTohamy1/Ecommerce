...
using ECommerce.Application.Features.Brands.Queries.GetPagedBrands;

namespace ECommerce.API.Pages.Brands;
...
public class IndexModel : RazorPageBase
{
    ...
    public PagedResult<BrandDto> Result { get; set; } = new();
    ...
    public async Task OnGetAsync([FromQuery] int? page, [FromQuery] int? pageNumber)
    {
        ...
        PageNumber = p;
        Result = await _mediator.Send(new GetPagedBrandsQuery(p, 12));
    }
